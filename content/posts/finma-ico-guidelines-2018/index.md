---
title: "FINMA's ICO Guidelines in 2018: What They Revealed About Switzerland's Regulatory Philosophy"
date: 2018-02-18
lastmod: 2026-05-04
description: "On February 16, 2018, FINMA published six pages that changed the global conversation on crypto regulation. A field note on the three-token classification framework, why FINMA chose taxonomy over prohibition, and why this document still matters in 2026."
categories: ["regulation"]
tags: ["FINMA ICO guidelines 2018", "swiss crypto 2018", "token classification", "crypto regulation switzerland", "payment utility asset tokens"]
draft: false
image: hero.jpg
readtime: 7
glossary:
  - term: "ICO Guidelines (2018)"
    def: "FINMA's official guidelines published February 16, 2018, titled 'FINMA publishes ICO guidelines.' The document classified tokens into three functional categories — payment, utility, and asset — and specified which financial market laws applied to each. It replaced the informal regulatory engagement FINMA had been providing through case-by-case guidance since 2017 and became the first comprehensive token classification framework published by a major financial regulator globally."
  - term: "Payment Token"
    def: "FINMA's first token category: tokens functioning as means of payment and carrying no further rights or links to a development project. Payment tokens are subject to anti-money laundering requirements but are not treated as securities. Bitcoin and Ether were the paradigmatic examples at the time of the guidelines. The AML obligation applied as soon as the tokens could be transferred."
  - term: "Utility Token"
    def: "FINMA's second token category: tokens providing digital access rights to an application or service. A utility token escapes securities treatment only if its sole purpose is conferring such access rights AND if it can actually be used in that way at the time of issuance. This 'usable at issuance' condition disqualified most 2017-era ICOs for tokens that funded development of platforms not yet operational."
  - term: "Asset Token"
    def: "FINMA's third token category: tokens representing assets — participations in companies, earnings streams, entitlements to dividends or interest payments. FINMA treated asset tokens as securities, triggering prospectus requirements and securities law obligations under the Swiss Code of Obligations. Hybrid tokens with both asset and utility properties were assessed based on their primary economic function."
  - term: "Hybrid Token"
    def: "FINMA's acknowledgment that tokens could combine features of multiple categories. A token with both payment and utility features would be assessed against both regulatory frameworks. A token with both utility and asset features that functioned primarily as an investment vehicle would be treated as an asset token regardless of any access-right framing. The hybrid concept became important for DeFi governance tokens assessed under later guidance."
sources:
  - name: "FINMA — FINMA publishes ICO guidelines"
    url: "https://www.finma.ch/en/news/2018/02/20180216-mm-ico-wegleitung/"
    desc: "finma.ch — official FINMA press release and guidelines document, February 16, 2018"
  - name: "Baker McKenzie — Regulatory Aspects of ICOs in Switzerland"
    url: "https://www.bakermckenzie.com/en/-/media/files/insight/publications/2018/03/regulatory-aspects-ico-switzerland/br_switzerland_regulatoryaspectsico_mar2018.pdf"
    desc: "bakermckenzie.com — legal analysis of the FINMA ICO guidelines, March 2018"
  - name: "CMS Law — FINMA ICO Guidelines"
    url: "https://cms.law/en/che/legal-updates/finma-ico-guidelines"
    desc: "cms.law — Swiss legal commentary on the February 2018 guidelines"
  - name: "Cassels — Swiss Regulators Set Precedent with Groundbreaking ICO Guidelines"
    url: "https://cassels.com/insights/swiss-regulators-set-groundbreaking-ico-guidelines/"
    desc: "cassels.com — cross-jurisdictional analysis of FINMA's approach, 2018"
  - name: "Lenz & Staehelin — FINMA issues guidelines on ICO financial regulation"
    url: "https://www.lenzstaehelin.com/fileadmin/user_upload/publications/180309_Newsflash_-_ICO_Guidelines_-_Final.pdf"
    desc: "lenzstaehelin.com — Swiss law firm newsflash on the guidelines, March 2018"
  - name: "StartupTicker — FINMA publishes ICO guidelines"
    url: "https://www.startupticker.ch/en/news/february-2018/finma-publishes-ico-guidelines"
    desc: "startupticker.ch — Swiss startup ecosystem coverage of the February 2018 announcement"
---
...
{{< num-highlight value="16 Feb 2018" label="Date FINMA published its ICO Guidelines" note="The document replaced informal case-by-case engagement with an explicit three-category framework. It was the first comprehensive token classification system published by a major financial regulator globally." >}}
...
{{< skip-box title="What 'case-by-case' meant in practice in 2018" >}}
...
{{< num-highlight value="2018 → 2026" label="Years FINMA's functional analysis framework has operated" note="Payment / utility / asset classification from February 2018 became the basis for the 2019 banking licences, the 2021 DLT Act, and FINMA's 2026 crypto custody guidance. Eight years without a fundamental revision to the underlying analytical logic." >}}
...
*Related field notes: [The ICO Boom Seen From Zug: What 2017-2018 Was Actually Like Here](/posts/ico-boom-zug-2017-2018/) — the ecosystem context the guidelines were responding to. [When FINMA Gave Crypto Its First Banking Licenses: A 2019 Field Report](/posts/finma-crypto-license-2019/) — the next step in the regulatory architecture the 2018 guidelines established. [The DLT Act Explained Without a Law Degree](/posts/dlt-act-switzerland-explained/) — how the 2021 legislation built on the token classification framework.*
