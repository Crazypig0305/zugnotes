---
title: "Why Ethereum Was Born in Zug: The 2014-2017 Origin Story Most People Get Wrong"
date: 2017-08-15
lastmod: 2026-05-03
description: "Ethereum chose Zug not because of tax rates but because Swiss foundation law gave the 2014 presale legal structure no other jurisdiction offered. A field note on the real origin story — the spaceship house, Stiftung Ethereum, and how Crypto Valley got its name."
categories: ["ecosystem"]
tags: ["ethereum history", "crypto valley origin", "stiftung ethereum", "zug 2014", "ethereum founding", "swiss foundation law"]
draft: false
image: hero.jpg
readtime: 11
canonicalURL: "https://zugnotes.com/posts/why-ethereum-born-in-zug/"
glossary:
  - term: "Stiftung Ethereum"
    def: "The Ethereum Foundation in its Swiss legal form — 'Stiftung' is the German word for foundation. Registered in Zug on July 9, 2014. Still the legal entity that stewards the Ethereum protocol and manages the treasury from the 2014 presale."
  - term: "EthSuisse"
    def: "Ethereum Switzerland GmbH — the for-profit Swiss limited liability company established in early 2014 to manage Ethereum development before the foundation existed. EthSuisse conducted the actual 2014 ether presale and was later liquidated once operations transferred to the Ethereum Foundation."
  - term: "Crypto Valley (pre-2017)"
    def: "The term was coined by Ethereum co-founder Mihai Alisie during discussions with Zug officials in 2014, envisioning Zug as a 'Silicon Valley for blockchain.' The Crypto Valley Association was not formally established until January 2017, but the name circulated from 2014 onward."
  - term: "Devcon 0"
    def: "The first Ethereum developer conference, held in Berlin in November 2014 — before the mainnet even launched. Around 100 developers gathered in Kreuzberg to outline the protocol's architecture. It established the tradition of annual Devcon gatherings that continues today."
  - term: "Swiss Foundation Law"
    def: "The Swiss Civil Code provisions (Art. 80–89a ZGB) governing foundations (Stiftungen). Key features relevant to crypto: foundations can hold assets for a designated public or private purpose, are legally distinct from their founders, and in 2014 provided clearer fund management rules for token presales than any alternative jurisdiction."
  - term: "Das Raumschiff"
    def: "German for 'The Spaceship' — the modest house in Zug's canton where the Ethereum team worked during 2014-2015. Described by Ethereum Foundation advisor Bernd Lapp as 'like a shoe box... people were living there on mattresses, almost like a hostel.' It became shorthand for Ethereum's early Zug chapter."
sources:
  - name: "Ethereum Foundation — History and Founder"
    url: "https://ethereum.org/ethereum-history-founder-and-ownership/"
    desc: "ethereum.org — official history of Ethereum's founding, legal structure, and Zug origin"
  - name: "Ethereum Homestead Guide — History of Ethereum"
    url: "https://github.com/ethereum/homestead-guide/blob/master/source/introduction/history-of-ethereum.rst"
    desc: "Ethereum Foundation documentation — early community-written history with primary-source detail"
  - name: "CoinDesk — Sale of the Century: Inside Story of Ethereum's 2014 Premine"
    url: "https://www.coindesk.com/markets/2020/07/11/sale-of-the-century-the-inside-story-of-ethereums-2014-premine"
    desc: "CoinDesk — detailed reconstruction of the 2014 presale mechanics and legal structure, July 2020"
  - name: "Decrypt — Who Are Ethereum's Co-Founders and Where Are They Now?"
    url: "https://decrypt.co/36641/who-are-ethereums-co-founders-and-where-are-they-now"
    desc: "Decrypt — profiles of all eight co-founders including Mihai Alisie's Zug role, 2020"
  - name: "Devcon 0 Recap — Ethereum Foundation Blog"
    url: "https://blog.ethereum.org/en/2014/12/05/devcon-0-recap"
    desc: "Ethereum Foundation Blog — official recap of the first developer conference, Berlin, November 2014"
  - name: "S-GE — Ethereum Success Story: Switzerland"
    url: "https://www.s-ge.com/en/article/success-stories/20193-successstory-ethereum"
...
{{< num-highlight value="8" label="Co-founders gathered in Zug, June 7, 2014" note="The meeting where the non-profit structure was decided. Two co-founders (Hoskinson, Chetrit) left the project shortly after, preferring a commercial model." >}}
...
{{< num-highlight value="60M ETH" label="Sold in the 2014 presale" note="42-day sale, July–September 2014. Raised ~$18.3M at the time. Conducted through EthSuisse under Stiftung Ethereum legal structure." >}}
...
{{< num-highlight value="2017" label="Year Crypto Valley Association formally established" note="January 2017. By then ~40 crypto foundations had already registered in Zug, most following the Stiftung Ethereum legal template from 2014." >}}
