...
glossary:
  - term: "CARF"
    def: "Crypto-Asset Reporting Framework. The OECD standard for automatic cross-border exchange of crypto-asset information between tax authorities. Switzerland enacted it into law on January 1, 2026, but delayed actual data exchange until at least 2027."
  - term: "AEOI"
    def: "Automatic Exchange of Information. The umbrella term for Switzerland's international tax data sharing regime, which includes CRS (Common Reporting Standard) for traditional financial accounts and CARF for crypto assets."
  - term: "SFTA"
    def: "Swiss Federal Tax Administration (Eidgenössische Steuerverwaltung, ESTV). The federal agency responsible for collecting crypto-asset reporting data from Swiss service providers and conducting the international exchange with partner states."
  - term: "RCASP"
    def: "Reporting Crypto-Asset Service Provider. Any entity — bank, exchange, wallet operator, or broker — that offers commercial crypto transaction services in Switzerland and is therefore subject to CARF due diligence, data collection, and reporting obligations."
  - term: "Reporting trigger"
    def: "The transaction type or asset type that activates a reporting obligation under CARF. Exchanges of crypto for fiat, crypto-to-crypto swaps, and transfers to external wallets all qualify. Self-custodied assets with no service provider involvement do not."
  - term: "CRS"
    def: "Common Reporting Standard. The OECD framework for sharing traditional financial account information between tax authorities — the predecessor model that CARF extends into crypto assets."
sources:
  - name: "Alpadis — Switzerland Delays Exchange of Crypto-Asset Information to 2027"
    ...
    desc: "alpadis.com — January 2026 announcement breakdown with practical implications"
  - name: "Swiss Federal Council — dispatch approving partner states for AEOI on cryptoassets"
    url: "https://www.news.admin.ch/en/newnsb/1QknKQ4iBGdl3Q7I4CL7b"
    desc: "admin.ch — official Federal Council announcement, June 2025"
  - name: "MME Legal — Automatic Exchange of Information on Crypto-Assets"
    url: "https://www.mme.ch/en/magazine/articles/automatic-exchange-of-information-on-crypto-assets"
    desc: "mme.ch — transaction scope and timeline analysis, 2026"
  - name: "STEP — Switzerland delays crypto-asset information exchange to 2027"
    url: "https://www.step.org/industry-news/switzerland-delays-crypto-asset-information-exchange-2027"
    desc: "step.org — STEP industry summary of the delay announcement"
...
{{< num-highlight value="74" label="Partner jurisdictions" note="All EU member states, the UK, and most G20 countries — excluding the US, China, and Saudi Arabia" >}}
...
<div class="data-callout">
<p class="callout-label">Regulatory pattern note</p>
<p>Switzerland applied similar scrutiny when expanding CRS to include associations and foundations in its 2026 update. The caution is procedural, not ideological. The direction of travel — toward full CARF exchange with appropriately qualified partners — has not changed.</p>
</div>
...
{{< skip-box title="A note on the legal advice you are not reading here" >}}
Nothing in this field note constitutes tax or legal advice. CARF's application to any specific holding structure depends on facts that require qualified professional assessment — your tax residency, the type of assets held, which Swiss institutions you use, and the relevant laws of your country of residence. The landscape is genuinely complex. A professional who knows your situation is the appropriate first call.
{{< /skip-box >}}
...
*Related field notes: [FINMA's Crypto Guidance 01/2026](/posts/finma-crypto-guidance-01-2026/) explains the custody infrastructure that CARF reporting depends on at the institutional level. [The Swiss Crypto Tax Advantage](/posts/swiss-crypto-tax-advantage-guide/) covers the wealth tax and capital gains regime that operates independently of CARF. [MiCA vs. FINMA](/posts/mica-vs-finma-field-note/) examines how the EU regulatory framework that governs CARF partner states interacts with Switzerland's approach.*
