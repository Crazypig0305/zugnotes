---
title: "CV Labs and the Zug Co-working Scene: Is the Crypto Valley Hype Real?"
date: 2024-03-12
lastmod: 2026-05-03
description: "CV Labs claims 200+ tenants and the title 'heartbeat of Crypto Valley.' Is the hype real? A field note on what the Zug co-working scene actually looks like — the density, the community events, and why some crypto companies in Zug are not in CV Labs at all."
categories: ["ecosystem"]
tags: ["CV labs zug", "crypto valley coworking", "web3 zug community", "Spaces Zug", "Trust Square", "blockchain switzerland workspace"]
draft: false
image: hero.jpg
readtime: 10
canonicalURL: "https://zugnotes.com/posts/cv-labs-zug-coworking-scene/"
glossary:
  - term: "CV Labs"
    def: "Crypto Valley Labs. The co-working and incubation hub at Dammstrasse 16, Zug — directly linked to CV VC. Hosts 200+ tenants and provides domicile registration, accelerator programs, and community events for blockchain companies."
  - term: "CV VC"
    def: "Crypto Valley Venture Capital. The Zug-based VC fund that operates CV Labs. CV VC and CV Labs are separate legal entities but share infrastructure, brand, and deal flow — understanding the relationship is key to understanding why CV Labs has gravitational pull."
  - term: "Coffee Morning"
    def: "Informal community networking sessions hosted at CV Labs Zug on a regular basis. Low-formality gatherings — coffee, standing conversations, no slide decks — designed to let founders, advisors, and investors run into each other without a formal agenda."
  - term: "Trust Square"
    def: "A Zurich-based blockchain and Web3 innovation hub at Rennweg 57, near Bahnhofstrasse. Offers 350+ workstations across 3,500 sqm. Focuses on blockchain, cybersecurity, and AI. Hosts close to 300 events per year. Zurich-centric, distinct from the Zug ecosystem."
  - term: "Domicile Registration"
    def: "A Swiss legal mechanism allowing a company to register its official address at a service provider's address without renting physical office space. CV Labs offers this service — meaning a company can have a Zug address and canton Zug tax status without actually working from the building day-to-day."
  - term: "Spaces Zug"
    def: "A co-working location in Zug operated by the global Spaces brand (IWG group). Professional all-sectors workspace, not crypto-specific. Relevant comparison point: similar location, different community composition."
sources:
  - name: "CV Labs — Location: CV Labs Zug"
    url: "https://www.cvlabs.com/location/cv-labs-zug"
    desc: "CV Labs official page for the Zug location — tenant count, services, address (Dammstrasse 16), and amenities"
  - name: "CV VC — What is CV Labs?"
    url: "https://www.cvvc.com/what-is-cv-labs"
    desc: "CV VC's own description of CV Labs — the relationship between the VC fund and the ecosystem builder"
  - name: "CV Labs — Blockchain Coworking Space"
    url: "https://www.cvlabs.com/services/cowork"
    desc: "CV Labs coworking services page — office types, domicile service, and event access"
  - name: "CV VC — Crypto Valley Grows 132% Since 2020: Now Hosts 1,749 Companies"
    ...
    desc: "CV VC press release — primary data source for ecosystem company count and CV Labs tenant figures"
  - name: "Trust Square — Coworking Space, Zurich"
    url: "https://www.trustsquare.com"
    desc: "Trust Square official site — Zurich-based blockchain and Web3 innovation hub, comparative reference"
  - name: "FintechNews Switzerland — 4 Coworking Spaces in Switzerland for Fintech and Blockchain"
    url: "https://fintechnews.ch/fintech/fintech-blockchain-coworking-space-switzerland/27210/"
    desc: "FintechNews overview of crypto-friendly co-working options across Switzerland"
  - name: "CV Labs — Events"
    url: "https://www.cvlabs.com/events/upcoming-events"
    desc: "CV Labs upcoming events page — community programming, coffee mornings, and accelerator events"
  - name: "Crypto Valley 2026 Snapshot — Zug Notes"
    url: "/posts/crypto-valley-2026-snapshot/"
    desc: "Related: the broader ecosystem numbers behind the CV Labs tenant count"
  - name: "Why Ethereum Was Born in Zug — Zug Notes"
    url: "/posts/why-ethereum-born-in-zug/"
    desc: "Related: how CV Labs fits into the longer history of Zug as a crypto hub"
---
...
{{< num-highlight value="200+" label="Companies and tenants" note="Current count at CV Labs Zug, Dammstrasse 16. Up from roughly 130 at the original 18-month review point." >}}
...
{{< skip-box title="What the coffee morning is actually good for" >}}
...
|---|---|---|---|---|
| CV Labs | Dammstrasse 16, Zug | Yes | Early-stage blockchain founders, domicile + community | Density varies; domicile ≠ working presence |
| Trust Square | Rennweg 57, Zurich | Yes (broader: blockchain + cyber + AI) | Zurich-based founders, 300 events/year | Different city — not Zug ecosystem specifically |
| Spaces Zug | Central Zug | No | Professional, flexible; all sectors | No crypto community overlay |
| Dedicated lease | Various Zug | N/A | Companies past early stage | Higher fixed cost; you manage your own community |
{{< /budget-table >}}
...
{{< num-highlight value="38" label="New incorporations in 2024" note="CV Labs Zug recorded 38 new company incorporations in 2024 — a 124% year-on-year increase. Reflects both ecosystem momentum and the domicile service's pull." >}}
...
For more on the broader ecosystem that gives CV Labs its context, the [2026 Crypto Valley snapshot](/posts/crypto-valley-2026-snapshot/) covers the 1,749-company figure in detail. The [Ethereum origin story](/posts/why-ethereum-born-in-zug/) covers how Zug became the address of choice before any of this infrastructure existed.
