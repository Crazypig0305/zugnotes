...
image: hero.jpg
readtime: 13
canonicalURL: "https://zugnotes.com/posts/ico-boom-zug-2017-2018/"
glossary:
  - term: "ICO (Initial Coin Offering)"
    def: "A fundraising mechanism where a blockchain project issues tokens to investors in exchange for established cryptocurrencies (typically BTC or ETH). ICOs occupied a legal gray zone in 2017: they were not formally classified as securities offerings in most jurisdictions, which allowed projects to raise funds globally with minimal regulatory overhead. FINMA's February 2018 guidelines were among the first major regulatory frameworks to classify tokens by function."
  - term: "Tezos Foundation"
    def: "A Swiss foundation established in Zug on April 17, 2017, created to support the Tezos blockchain protocol developed by Arthur and Kathleen Breitman. The foundation conducted the Tezos ICO in July 2017, raising $232 million — the largest ICO at that time. The subsequent governance dispute between the foundation's president Johann Gevers and the Breitmans became the defining public crisis of Crypto Valley's ICO era."
  - term: "FINMA ICO Guidelines"
    def: "Guidelines published by the Swiss Financial Market Supervisory Authority on February 16, 2018, establishing a classification framework for tokens: payment tokens (cryptocurrencies), utility tokens (access rights to a service), and asset tokens (representing assets or earnings streams, treated as securities). The guidelines were the first major economy-level regulatory framework for ICOs and replaced the legal vacuum that had allowed the 2017 boom."
  - term: "Crypto Winter"
    def: "The extended bear market that began in January 2018 and lasted through 2019. Bitcoin fell from a peak of approximately $19,783 (December 2017) to a low of $3,122 (December 2018). For Crypto Valley, the winter was compounded by regulatory tightening: Swiss banks restricted services to crypto businesses following the Tezos scandal, and ICO volume dropped from 184 in 2018 to 94 in 2019."
  - term: "Swiss Foundation (Stiftung)"
    def: "A legal entity under Swiss Civil Code (Art. 80–89a ZGB) designed to hold assets for a defined purpose, legally distinct from its founders. In the ICO era, foundations were the dominant legal vehicle in Zug because they could hold large token sale proceeds without the profit-distribution obligations of corporate structures. The Tezos scandal exposed the governance risks of this model: once funds are in a Stiftung, the foundation's board — not the project founders — controls them."
sources:
  - name: "CoinDesk — $232 Million: Tezos Blockchain Project Finishes Record-Setting Token Sale"
    url: "https://www.coindesk.com/markets/2017/07/13/232-million-tezos-blockchain-project-finishes-record-setting-token-sale"
    desc: "coindesk.com — contemporaneous reporting on the Tezos ICO completion, July 2017"
  - name: "FINMA — FINMA publishes ICO guidelines"
    url: "https://www.finma.ch/en/news/2018/02/20180216-mm-ico-wegleitung/"
    desc: "finma.ch — official FINMA press release on ICO guidelines, February 16, 2018"
  - name: "SWI swissinfo.ch — Crypto piggybank foundations proliferate in Zug"
    url: "https://www.swissinfo.ch/eng/business/500-million-business_crypto-piggybank-foundations-proliferate-in-zug/43494680"
    desc: "swissinfo.ch — analysis of Zug foundation proliferation during the ICO boom"
  - name: "SWI swissinfo.ch — Lawyers circle over Tezos Foundation dispute"
    url: "https://www.swissinfo.ch/eng/business/crypto-lawsuits_lawyers-circle-over-tezos-foundation-dispute/43623968"
    desc: "swissinfo.ch — reporting on the Tezos governance crisis and Gevers dispute"
  - name: "finews.com — Record ICO's Swiss Ties Raise Eyebrows"
    url: "https://www.finews.com/news/english-news/28253-tezos-ico-swiss-foundation-dls-kathleen-arthur-breitman"
    desc: "finews.com — Swiss financial press analysis of the Tezos ICO and its Zug foundation structure"
  - name: "CNBC — Backroom battle imperils $230 million cryptocurrency venture"
    url: "https://www.cnbc.com/2017/10/19/backroom-battle-imperils-230-million-cryptocurrency-venture.html"
    desc: "cnbc.com — October 2017 reporting on the emerging Tezos Foundation dispute"
  - name: "CV VC — 18 Months CV Labs in Review"
    url: "https://medium.com/cv-vc/18-months-cv-labs-in-review-19c25cb55230"
    desc: "CV VC Medium — retrospective on CV Labs' ICO-era growth and floor expansion, 2018"
  - name: "Crypto Valley Pioneers — Top Five Tops und Flops im Crypto Valley"
    url: "https://www.cryptovalleypioneers.ch/en/top-five-tops-und-flops-im-crypto-valley/"
    desc: "cryptovalleypioneers.ch — insider evaluation of Crypto Valley's ICO-era wins and failures"
  - name: "Bitcoin Magazine — Swiss Regulator Gives Clear Guidelines for Launching ICOs"
    url: "https://bitcoinmagazine.com/business/swiss-regulator-gives-clear-guidelines-launching-icos"
    desc: "bitcoinmagazine.com — analysis of FINMA's February 2018 ICO guidelines"
  - name: "SWI swissinfo.ch — Swiss regulator probes ICOs following fake coin scandal"
    url: "https://www.swissinfo.ch/eng/business/cryptocurrencies_swiss-regulator-probes-icos-following-fake-coin-scandal/43559552"
    desc: "swissinfo.ch — FINMA enforcement actions against fraudulent ICOs"
---
...
{{< num-highlight value="$232M" label="Raised by Tezos Foundation, July 2017" note="65,627 BTC + 361,122 ETH raised over 13 days. Largest ICO at the time, surpassing Bancor's $150M. The Tezos Foundation was registered in Zug on April 17, 2017." >}}
...
{{< num-highlight value="~40%" label="Estimated legal and compliance cost share for smaller ICOs" note="Anecdotal from practitioners at the time. Smaller ICOs raising under CHF 5M found that foundation setup, legal opinion letters, and banking compliance consumed a large share of gross proceeds." >}}
...
{{< num-highlight value="Feb 2018" label="Gevers resigned from Tezos Foundation" note="After months of public dispute, governance crisis resolved with board reconstitution. Tezos mainnet launched September 2018. The episode prompted Swiss banks to restrict crypto business accounts." >}}
...
{{< num-highlight value="184" label="ICOs launched in Switzerland in 2018" note="Down to 94 in 2019. FINMA investigated 60 of the 2018 cohort. The framework that the February 2018 guidelines established became the basis for the [FINMA crypto license structure](/posts/finma-crypto-license-2019/) that followed in 2019." >}}
...
*Related field notes: [Why Ethereum Was Born in Zug](/posts/why-ethereum-born-in-zug/) — the 2014 legal template that the ICO boom borrowed and stress-tested. [When FINMA Gave Crypto Its First Banking Licenses](/posts/finma-crypto-license-2019/) — what 2019 looked like after the Crypto Winter, when the projects that survived got institutional recognition. [What Crypto Valley Actually Looks Like in 2026](/posts/crypto-valley-2026-snapshot/) — the ecosystem that grew from this foundation.*
