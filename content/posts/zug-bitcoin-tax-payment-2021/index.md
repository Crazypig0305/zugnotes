---
title: "The Year Zug Let You Pay Taxes in Bitcoin: A Field Note from 2021"
date: 2021-09-12
lastmod: 2026-05-04
description: "In February 2021, Canton Zug became the first Swiss canton to accept Bitcoin and Ether for tax payments — up to CHF 100,000 per bill. A field note on what it meant, how it actually worked, and why the real story is more interesting than the headline."
categories: ["ecosystem"]
tags: ["zug bitcoin tax payment 2021", "crypto valley history", "bitcoin suisse", "switzerland crypto adoption", "canton zug cryptocurrency"]
draft: false
image: hero.jpg
readtime: 7
canonicalURL: "https://zugnotes.com/posts/zug-bitcoin-tax-payment-2021/"
glossary:
  - term: "Canton"
    def: "Switzerland is divided into 26 cantons — semi-autonomous states with their own parliaments, governments, and significant powers over taxation and local legislation. Zug is one of the smallest cantons by area but among the most internationally prominent due to its low corporate tax rates and concentration of blockchain companies."
  - term: "Bitcoin Suisse"
    def: "A Swiss crypto-financial services company founded in 2013 and headquartered in Zug. Bitcoin Suisse was the partner entity that processed Zug's crypto tax payments in 2021 — converting incoming BTC and ETH into CHF before settlement with the cantonal Finance Department. The canton therefore never held cryptocurrency directly."
  - term: "Wealth tax"
    def: "Switzerland levies an annual wealth tax on the net assets of resident individuals, including cryptocurrency holdings valued at their December 31 market price. The absence of a capital gains tax on private crypto holdings — combined with the presence of a wealth tax — is the defining feature of the Swiss crypto tax framework."
  - term: "Legal tender"
    def: "A medium of payment that a creditor is legally required to accept in settlement of a debt. Switzerland never classified Bitcoin or Ether as legal tender. The Canton of Zug accepted crypto as a voluntary payment option — not as currency — and merchants were under no obligation to follow suit."
sources:
  - name: "Canton Zug to accept cryptocurrencies for tax payment beginning in 2021 — Bitcoin Suisse"
    url: "https://www.bitcoinsuisse.com/news/canton-zug-accept-cryptocurrencies-for-tax-payment-in-2021"
    desc: "bitcoinsuisse.com — official announcement of the 2021 crypto tax payment partnership"
  - name: "Switzerland's Crypto Valley Has Started Accepting Bitcoin, Ether for Tax Payments — CoinDesk"
    url: "https://www.coindesk.com/markets/2021/02/18/switzerlands-crypto-valley-has-started-accepting-bitcoin-ether-for-tax-payments"
    desc: "coindesk.com — coverage of the February 2021 launch"
  - name: "Zug first to accept bitcoin for government services — SWI swissinfo.ch"
    url: "https://www.swissinfo.ch/eng/business/crypto-valley_zug-first-to-accept-bitcoin-for-government-services/42143908"
    desc: "swissinfo.ch — reporting on the 2016 municipality pilot program"
  - name: "Swiss canton Zug increases bitcoin, ether tax payment limit — The Block"
    ...
    desc: "theblock.co — report on the 2023 limit increase to CHF 1.5 million, including early usage statistics"
  - name: "Swiss Town Will Accept Bitcoin for Tax Payments in 2018 — CCN"
    url: "https://www.ccn.com/swiss-town-will-accept-bitcoin-tax-payments-2018/"
    desc: "ccn.com — coverage of the 2017–2018 period when Zug municipality expanded its crypto payment experiments"
---
...
{{< num-highlight number="CHF 100,000" label="maximum tax bill payable in cryptocurrency per invoice under the 2021 rules" >}}
...
<p class="callout-label">Structural note — February 2021</p>
...
{{< num-highlight number="~150" label="crypto tax transactions processed by Canton Zug in the first two years after launch (2021–2023)" >}}
...
{{< num-highlight number="2016 → 2021 → 2023" label="Zug's crypto payment milestones: city pilot → canton tax program → CHF 1.5M ceiling increase" >}}

Five years on, that still looks like the right read.

---

*Field note from Zug. Not financial or tax advice — crypto tax payment availability is subject to cantonal policy and may change. Verify current limits and procedures at [zg.ch](https://zg.ch) before making payment decisions.*
