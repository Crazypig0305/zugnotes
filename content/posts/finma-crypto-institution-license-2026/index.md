...
readtime: 10
glossary:
  - term: "Crypto-Institution (Krypto-Institut)"
    def: "A new license category proposed under the amended Financial Institutions Act (FinIA/FINIG). Covers firms providing custody, trading, staking, and exchange services for payment tokens — including Bitcoin and foreign stablecoins. Lighter than a full securities firm license but requiring direct FINMA supervision. Subject to formal consultation that closed February 6, 2026."
  - term: "Payment Instrument Institution (Zahlungsmittelinstitut)"
    def: "The second new license category proposed alongside the crypto-institution. Replaces the existing fintech license, removes the CHF 100 million deposit cap, and grants an exclusive right to issue CHF-pegged stablecoins that are fully backed, segregated, and redeemable at par. Banks must spin off a separate subsidiary to hold this license."
  - term: "FinIA / FINIG"
    def: "Financial Institutions Act (Finanzinstitutsgesetz). The Swiss federal law governing investment firms, fund managers, and — under the proposed 2025 amendments — the new crypto-institution and payment instrument institution categories. Amended versions are expected to enter into force not before 2027."
  - term: "SRO (Self-Regulatory Organization)"
    def: "Swiss self-regulatory bodies that currently supervise most crypto firms for AML/CFT compliance purposes. Under the proposed FinIA reform, many SRO-supervised crypto providers would shift to direct FINMA oversight once they obtain the relevant new license."
  - term: "Fintech License"
    def: "A lighter banking license category introduced in 2019, permitting firms to accept public deposits up to CHF 100 million without engaging in lending. The proposed reform replaces this with the payment instrument institution category, which removes the deposit cap and adds stablecoin issuance rights."
  - term: "MiCA (Markets in Crypto-Assets Regulation)"
    def: "The EU-wide regulation for crypto-asset service providers, fully in force since December 2024. The Swiss proposal explicitly aligns with MiCA's approach to stablecoins and crypto service licensing — particularly the fully-backed, segregated stablecoin model and the CASP (Crypto-Asset Service Provider) licensing concept."
sources:
  - name: "Swiss Federal Council — Consultation on FinIA Amendment (October 22, 2025)"
    url: "https://www.admin.ch/gov/en/start/documentation/media-releases.html"
    desc: "admin.ch — official consultation announcement, October 22, 2025"
  - name: "MME Legal — Switzerland Proposes New Crypto License Categories"
    url: "https://www.mme.ch/en/magazine/articles/switzerland-proposes-new-crypto-license-categories-and-strengthens-consumer-protection"
    desc: "mme.ch — detailed legal commentary on the proposed FinIA amendments"
  - name: "Velaw — Crypto-Institution License Under FINIG"
    url: "https://www.velaw.ch/en/crypto-institution-license-under-finig-the-next-regulatory-stage-for-the-swiss-crypto-market-federal-council-moves-forward-with-stablecoins-and-cryptos-consultation-opened/"
    desc: "velaw.ch — practical analysis of the consultation paper, October 2025"
  - name: "MLL News — Switzerland's Next Step in Fintech and Crypto Regulation"
    url: "https://www.mll-news.com/switzerlands-next-step-in-fintech-and-crypto-regulation-new-categories-for-payment-instrument-institutions-and-crypto-institutions/?lang=en"
    desc: "mll-news.com — breakdown of both new license categories"
  - name: "Loyens & Loeff — FinIA Reform: New Licences for Payment and Crypto-Institutions"
    url: "https://www.loyensloeff.com/insights/news--events/news/swiss-federal-council-proposes-finia-amendments-new-licences-for-payment-and-crypto-institutions-to-replace-fintech-regime/"
    desc: "loyensloeff.com — comparative analysis: new vs. existing license regime"
...
The result is that the industry has been running on a patchwork. FINMA has been issuing guidance — most recently the [custody guidance from January 2026](/posts/finma-crypto-guidance-01-2026/) — to fill gaps within that existing framework. But guidance has limits. You cannot patch a structural mismatch with circulars.
...
{{< skip-box title="Who the crypto-institution license is for" >}}
Think of the firms that currently operate under SRO supervision — exchanges, custodians, brokers that are not banks. The crypto-institution license is built for them. It provides a formal regulatory home that is lighter than a full securities firm license, but requires direct FINMA oversight rather than just SRO registration.
{{< /skip-box >}}
...
1. The Federal Council reviews consultation responses and prepares a final draft
2. Parliament debates and votes on the FinIA amendment
3. Once passed, an implementation period allows existing firms to transition
...
- [When FINMA Gave Crypto Its First Banking Licenses: A 2019 Field Report](/posts/finma-crypto-license-2019/) — the origin point of Switzerland's crypto licensing story
- [The DLT Act Explained Without a Law Degree](/posts/dlt-act-switzerland-explained/) — the legislative infrastructure this builds on
- [FINMA's Crypto Guidance 01/2026: What It Actually Means for Custody](/posts/finma-crypto-guidance-01-2026/) — the parallel custody rulemaking from the same regulatory moment
